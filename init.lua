...
-- Diagnostic keymaps
vim.keymap.set('n', '<leader>dq', vim.diagnostic.setloclist, { desc = 'Open [D]ocument diagnostics [Q]uickfix list' })
vim.keymap.set('n', '<leader>dc', vim.diagnostic.open_float, { desc = 'Open [D]ocument diagnostic under [C]ursor' })
